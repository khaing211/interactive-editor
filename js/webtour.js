...
var config = [
    {
        ...
        "color"     : "white",
        "position"  : "TL",
        "text"      : "Debug why it is not working by showing the error.",
        "time"      : 5000
    },
    {
        "name"      : "tour_2",
        "bgcolor"   : "black",
        "color"     : "white",
        "text"      : "Use this timeline tool to show how this program run from begin to end.",
        "position"  : "TL",
        "time"      : 5000
    }
],
...
$("#tutorial").live("click", function(e){
    e.preventDefault();
    $("#helpModal").modal('hide'); // hide the modal
    showControls();
    startTour();
});
